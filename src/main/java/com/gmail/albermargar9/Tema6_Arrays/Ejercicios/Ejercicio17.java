...
//Crea la función public static int[ ] copiar(int tabla[ ], int longitud)
//que construye y devuelve una copia de la tabla origen con la longitud especificada. Si la longitud de la nueva
//tabla es: - Menor que la de la original, solo se copian los elementos que caben. - Mayor que la de la original,
//los elementos extras se inicializan por defecto

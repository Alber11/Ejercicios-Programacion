...
//Escribe la función int[] rellenaPares(int longitud, int fin), que crea y
//devuelve una tabla ordenada de longitud especificada, que se encuentra rellena con
//número pares aleatorios en el rango desde 2 hasta fin (incluido).
